...
export const Tab: FC<ITab> = ({ amount, firstTab, secondTab, thirdTab, firstContent, secondContent, thirdContent }) => {
    ...
    <Container styles={styles.container}>
      <div className={styles['bloc-tabs']}>
        <Button
          ...
          style={toggleState === 1 ? `${styles.tabs} ${styles['active-tabs']}` : styles.tabs}
          text={firstTab}
        ></Button>
        <Button
          style={toggleState === 2 ? `${styles.tabs} ${styles['active-tabs']}` : styles.tabs}
          onClick={() => setToggleState(2)}
          text={secondTab}
        ></Button>
        {amount > 2 && (
          <Button
            style={toggleState === 3 ? `${styles.tabs} ${styles['active-tabs']}` : styles.tabs}
