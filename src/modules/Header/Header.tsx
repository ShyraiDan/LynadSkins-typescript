          ...
          <ListItem style={styles.item}>
            ...
            <Link className={styles.link} to={'/'}>
              <Typeography variant={'h2'} fontSize={'20px'} color={'white'}>
                Lynad
                <Typeography variant={'span'} color={'purple'} fontSize={'20px'}>
                  Skins
                </Typeography>
              </Typeography>
            </Link>
      ...
      <div className={styles.left}>
        ...
        <AnimatePresence initial={false}>
          {(singInOpen.state || open) && (
            <Modal
              children={<SignInModal setState={setOpen} setOtherState={setSignUpOpen} />}
        ...
        <AnimatePresence initial={false}>
          {signUpOpen && (
            <Modal
              children={<SignUpModal setState={setSignUpOpen} setOtherState={setOpen} />}
