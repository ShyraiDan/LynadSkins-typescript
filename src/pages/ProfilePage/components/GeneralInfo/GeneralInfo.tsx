    ...
    <Container>
      ...
      <List>
        <ListItem style={styles.item}>
          <Typeography color={'white'}>{t('personalPage.trade_link')}</Typeography>
        ...
        <ListItem style={styles.item}>
          <div className={styles['links-item']}>
            <Typeography color={'white'}>{t('personalPage.seller_link')}</Typeography>
            <Typeography color={'white'}>https://lynadskins.money/?seller:</Typeography>
          </div>
          <div className={styles['btn-container']}>
            <Button hover={true} text={t('personalPage.apply')}></Button>
          </div>
