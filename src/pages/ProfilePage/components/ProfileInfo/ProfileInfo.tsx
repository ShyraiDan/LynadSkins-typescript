...
export const ProfileInfo: FC<IProfileInfo> = ({ data }) => {
  ...
  return (
    <Container>
      ...
      <List>
        <ListItem display={'flex'} justifyContent={'space-between'} style={styles.item}>
          <Typeography color={'grey'}>{t('personalPage.commission')}</Typeography>
          <Typeography color={'white'}>7%</Typeography>
        </ListItem>
        <ListItem display={'flex'} justifyContent={'space-between'} style={styles.item}>
          <Typeography color={'grey'}>{t('personalPage.registration')}</Typeography>
