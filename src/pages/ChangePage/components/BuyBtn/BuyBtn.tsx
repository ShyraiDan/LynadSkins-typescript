  ...
  return (
    <>
      ...
      <AnimatePresence initial={false}>
        {modal && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className={styles.modal}>
              ...
              <div>
                ...
                <div className={styles.skins}>
                  {change.yourItems.map((item: TSkin) => {
                    return <SmallItem data={item} key={item._id} type={'change'} />
                  })}
                </div>
              </div>
              <div>
            ...
            <div className={styles.change}>
              <Button text={t('change')} onClick={() => handleChange()} style={styles['btn-confirm']} hover={true} />
