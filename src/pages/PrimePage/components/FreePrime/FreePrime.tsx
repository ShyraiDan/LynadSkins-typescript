  ...
  return (
    <div className={styles['recomendation-cont']}>
      <div className={styles['recomendation-image']}>
        <motion.div initial='hidden' whileInView='visible' viewport={{ once: true }} className={styles.recomendation}>
          <MTypeography
            custom={1}
          ...
          <MTypeography m={'0 0 10px 0'} color={'grey'} custom={2} variants={textAnimation}>
