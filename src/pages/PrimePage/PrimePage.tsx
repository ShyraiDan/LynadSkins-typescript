...
export const PrimePage: FC = () => {
  ...
  return (
    <Container styles={styles.container}>
      ...
      <motion.div initial='hidden' whileInView='visible' viewport={{ once: true }} className={styles.advantages}>
        {advantages.map((item, i) => (
          <MAdvantage key={i} custom={i + 1} variants={textAnimation} data={item} />
        ))}
      </motion.div>
      <FreePrime />
      <div ref={table}>
