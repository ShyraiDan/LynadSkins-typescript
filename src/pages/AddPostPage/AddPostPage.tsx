    ...
    <Container styles={styles.container}>
      <div className={styles['image-container']}>
        ...
        <div className={styles.btns}>
          ...
          ></Button>
          <input onChange={handleChangeFile} type='file' hidden ref={inputFileRef} />
          {imageUrl && <Button text={t('blog.delete')} onClick={onClickRemoveImage}></Button>}
        </div>
      </div>
      <input
        type='text'
      ...
      <div className={styles.buttons}>
        <Button onClick={onSubmit} text={isEditing ? t('blog.save') : t('blog.publish')} style={styles.submit}></Button>
        <a href='/blog'>
